...
class BlackJackUI(tk.Tk):
    ...
    def __init__(self):
        ...
        self.wm_title('game - 2019')
        self.configure(background='Green')
        self.gameTable = self.game_table(self)
        self.show_card(self.gameTable)
        self.mainloop()

    @staticmethod
    def game_table(master_window):
        bg_image = tk.PhotoImage(file='game/UserInterface/blackjacktable.png')
